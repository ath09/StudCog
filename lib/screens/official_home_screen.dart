...
class _OfficialHomeScreenState extends State<OfficialHomeScreen> {
                      ...
                      return Padding(
                        ...
                        child: ListTile(
                          ...
                          trailing: GestureDetector(
                            ...
                            onTap: () {
                              //student.doc(docIDs[index][2]).delete();
                              deletestudent(snapshot.data!.data());
                              setState(() {});
                            },
  ...
  deletestudent(time) async {
    await FirebaseFirestore.instance.collection("student").doc(time).delete();
